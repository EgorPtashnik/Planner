sap.ui.define([
    ...
    'planner/pages/arma/sqf/master/components/CreateFunctionDialog',
    'planner/pages/arma/sqf/master/components/ManageSqfTagsDialog'
], (BaseController, CreateFunctionDialog, ManageSqfTagsDialog) => {
    'use strict';

    return BaseController.extend('planner.pages.arma.sqf.master.SQFMaster', {
